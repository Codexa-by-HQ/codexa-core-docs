...
import { Braces, Database, Package, Server, Settings } from 'lucide-react';
...
<Cards>
  ...
  <Card icon={<Package />} title="SDK" href="/docs/sdk/overview" description="Generate a versioned, typed frontend package from documented routes." />
