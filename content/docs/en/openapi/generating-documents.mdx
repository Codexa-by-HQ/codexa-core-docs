...
<Callout type="info">
  The same opt-in metadata also powers [SDK generation](/docs/sdk/overview). Each included route becomes a typed SDK method, while its `params`, `query`, `body`, and response schemas become frontend TypeScript types.
</Callout>
...
<Cards>
  <Card title="Generated SDK" href="/docs/sdk/overview" description="Package documented routes as an installable, typed frontend client." />
